...
async function exportForAppHosting(projectRoot, publicUrl, assetUrl, outputDir, options = {}) {
  var _ref, _options$publishOptio;

  await _validatePackagerReadyAsync(projectRoot);
  const defaultTarget = (0, _config().getDefaultTarget)(projectRoot);
  const target = (_ref = (_options$publishOptio = options.publishOptions) === null || _options$publishOptio === void 0 ? void 0 : _options$publishOptio.target) !== null && _ref !== void 0 ? _ref : defaultTarget; // build the bundles
