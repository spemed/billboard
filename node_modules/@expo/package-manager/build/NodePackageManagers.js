...
class NpmPackageManager {
    ...
    removeLockfileAsync() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let lockfilePath = path_1.default.join(this.options.cwd, 'package-lock.json');
            if (fs_extra_1.default.existsSync(lockfilePath)) {
                fs_extra_1.default.removeSync(lockfilePath);
            }
        });
    }
    cleanAsync() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let nodeModulesPath = path_1.default.join(this.options.cwd, 'node_modules');
...
class YarnPackageManager {
    ...
    removeLockfileAsync() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let lockfilePath = path_1.default.join(this.options.cwd, 'yarn-lock.json');
            if (fs_extra_1.default.existsSync(lockfilePath)) {
                fs_extra_1.default.removeSync(lockfilePath);
            }
        });
