...
class CocoaPodsPackageManager {
    ...
    static gemInstallCLIAsync(nonInteractive = false, spawnOptions = { stdio: 'inherit' }) {
        return __awaiter(this, void 0, void 0, function* () {
            const options = ['install', 'cocoapods', '--no-document'];
            try {
                // Try the recommended way to install cocoapods first.
                yield spawn_async_1.default('gem', options, spawnOptions);
            }
            catch (error) {
                if (nonInteractive) {
                    throw error;
                ...
                yield PackageManager_1.spawnSudoAsync(`gem ${options.join(' ')}`);
            }
        });
    }
    static brewLinkCLIAsync(spawnOptions = { stdio: 'inherit' }) {
        return __awaiter(this, void 0, void 0, function* () {
            yield spawn_async_1.default('brew', ['link', 'cocoapods'], spawnOptions);
        });
    }
    static brewInstallCLIAsync(spawnOptions = { stdio: 'inherit' }) {
        return __awaiter(this, void 0, void 0, function* () {
            yield spawn_async_1.default('brew', ['install', 'cocoapods'], spawnOptions);
        });
    }
    static installCLIAsync({ nonInteractive = false, spawnOptions = { stdio: 'inherit' }, }) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!spawnOptions) {
    ...
    static isCLIInstalledAsync(spawnOptions = { stdio: 'inherit' }) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield spawn_async_1.default('pod', ['--version'], spawnOptions);
                return true;
            }
            catch (_a) {
                return false;
    ...
    _installAsync(shouldUpdate = true) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            try {
    ...
    versionAsync() {
        return __awaiter(this, void 0, void 0, function* () {
            const { stdout } = yield spawn_async_1.default('pod', ['--version'], this.options);
            return stdout.trim();
        });
    }
    getConfigAsync(key) {
