import { ExpRc, ExpoConfig, GetConfigOptions, PackageJSONConfig, ProjectConfig, ProjectTarget } from './Config.types';
/**
...
export declare function getPackageJson(projectRoot: string, config?: Pick<ExpoConfig, 'nodeModulesPath'>): PackageJSONConfig;
