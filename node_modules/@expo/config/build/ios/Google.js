...
function getGoogleMapsApiKey(config) {
    var _a, _b, _c;
    return _c = (_b = (_a = config.ios) === null || _a === void 0 ? void 0 : _a.config) === null || _b === void 0 ? void 0 : _b.googleMapsApiKey, (_c !== null && _c !== void 0 ? _c : null);
}
...
function getGoogleMobileAdsAppId(config) {
    var _a, _b, _c;
    return _c = (_b = (_a = config.ios) === null || _a === void 0 ? void 0 : _a.config) === null || _b === void 0 ? void 0 : _b.googleMobileAdsAppId, (_c !== null && _c !== void 0 ? _c : null);
}
exports.getGoogleMobileAdsAppId = getGoogleMobileAdsAppId;
function getGoogleSignInReservedClientId(config) {
    var _a, _b, _c, _d;
    return _d = (_c = (_b = (_a = config.ios) === null || _a === void 0 ? void 0 : _a.config) === null || _b === void 0 ? void 0 : _b.googleSignIn) === null || _c === void 0 ? void 0 : _c.reservedClientId, (_d !== null && _d !== void 0 ? _d : null);
}
exports.getGoogleSignInReservedClientId = getGoogleSignInReservedClientId;
function getGoogleServicesFile(config) {
    var _a, _b;
    return _b = (_a = config.ios) === null || _a === void 0 ? void 0 : _a.googleServicesFile, (_b !== null && _b !== void 0 ? _b : null);
}
...
function setGoogleServicesFile(config, projectRoot) {
    ...
    let googleServiceFilePath = path_1.default.resolve(projectRoot, googleServicesFileRelativePath);
    ...
    let projectName = Xcodeproj_1.getProjectName(projectRoot);
