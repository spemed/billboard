...
function getEntitlementsPath(projectRoot) {
    var _a;
    return _a = getExistingEntitlementsPath(projectRoot), (_a !== null && _a !== void 0 ? _a : createEntitlementsFile(projectRoot));
}
...
function createEntitlementsFile(projectRoot) {
    ...
    Object.entries(project.pbxXCBuildConfigurationSection())
        .filter(Xcodeproj_1.removeComments)
        .filter(Xcodeproj_1.isBuildConfig)
        .filter(Xcodeproj_1.removeTestHosts)
...
function getExistingEntitlementsPath(projectRoot) {
    const entitlementsPaths = glob_1.sync(path_1.default.join(projectRoot, 'ios', '*', '.entitlements'));
