...
function setStatusBarConfig(config, projectDirectory) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (hexString === 'translucent') {
            ...
            let colorItemToAdd = [{ _: hexString, $: { name: COLOR_PRIMARY_DARK_KEY } }];
        ...
        if (statusBarStyle === 'dark-content') {
            let statusBarStyleItem = [{ _: 'true', $: { name: WINDOW_LIGHT_STATUS_BAR } }];
