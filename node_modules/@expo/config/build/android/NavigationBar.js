...
function setNavigationBarConfig(config, projectDirectory) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (hexString) {
            let colorItemToAdd = [{ _: hexString, $: { name: NAVIGATION_BAR_COLOR } }];
        ...
        if (barStyle === 'dark-content') {
            let navigationBarStyleItem = [
                { _: 'true', $: { name: WINDOW_LIGHT_NAVIGATION_BAR } },
            ];
            stylesJSON = Styles_1.setStylesItem(navigationBarStyleItem, stylesJSON);
        }
        try {
