    ...
    modifyAsync(compiler, compilation, data) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.icon) {
                ...
                const iconAssets = yield expo_pwa_1.generateAppleIconAsync(this.pwaOptions, this.icon, {
                    sizes: requiredSizes,
                });
            ...
            if (this.startupImage) {
                const assets = yield expo_pwa_1.generateSplashAsync(this.pwaOptions, this.startupImage);
                const links = this.pwaOptions.links
