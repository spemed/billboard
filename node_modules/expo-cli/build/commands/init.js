...
function logProjectReady({
  ...
  if (workflow === 'bare') {
    ...
    _log().default.nested(`💡 You can also open up the projects in the ${_chalk().default.bold('ios')} and ${_chalk().default.bold('android')} directories with their respective IDEs.`); // TODO: add equivalent of this or some command to wrap it:
    // # ios
