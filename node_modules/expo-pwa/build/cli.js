...
assetCommand('icon', ['--platform safari -i ./icon.png', '--platform chrome -i ./icon.png'])
    ...
    .action((inputProjectRoot, options) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
...
assetCommand('favicon', ['-i ./icon.png'])
    ...
    validateSourceArgument(options.input, 'favicon');
    const projectRoot = (inputProjectRoot !== null && inputProjectRoot !== void 0 ? inputProjectRoot : process.cwd());
    const output = (_b = options.output, (_b !== null && _b !== void 0 ? _b : path_1.join(projectRoot, 'web')));
    try {
...
assetCommand('splash', ['--color blue --resize cover -i ./splash.png'])
    ...
    validateSourceArgument(options.input, 'favicon');
    const projectRoot = (inputProjectRoot !== null && inputProjectRoot !== void 0 ? inputProjectRoot : process.cwd());
    const output = (_c = options.output, (_c !== null && _c !== void 0 ? _c : path_1.join(projectRoot, 'web')));
    try {
...
outputCommand('manifest', ['-i ./random.config.js'])
    ...
    const output = (_d = options.output, (_d !== null && _d !== void 0 ? _d : path_1.join(projectRoot, 'web')));
    const publicPath = path_1.resolve((_e = options.public, (_e !== null && _e !== void 0 ? _e : output)));
