...
export default class ModifyAddress extends Component {
    ...
    constructor(props) {
        super(props)
        const {id,phone,name,address,description} = props.navigation.state.params.address
        this.state = {
            id,
            phone,
            name,
                ...
                <View style={{flexGrow:1,justifyContent:"flex-end"}}>
                    <TouchableOpacity 
                        ...
                        onPress={async ()=>{
                            ...
                            const {id,name,phone,address,description} = this.state
                            ...
                            const response = await AddressApi.modify(id,name.trim(),phone,address,description.trim())
                            ...
                            navigation.state.params.afterModifyNewRecordSuccessfully(data.address)
                            navigation.goBack();
                        }}
                    >
